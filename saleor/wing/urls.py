...
from .models import Wing as Table


urlpatterns = [
    url(r'^$', TemplateView.as_view(template_name="wing/list.html"), name="index"),
    ...
    url(r'^add/$', TemplateView.as_view(template_name="wing/form.html"), name='add'),
