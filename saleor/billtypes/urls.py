...
from .models import BillTypes as Table


urlpatterns = [
    url(r'^$', TemplateView.as_view(template_name="billtypes/list.html"), name="index"),
    ...
    url(r'^add/$', TemplateView.as_view(template_name="billtypes/form.html"), name='add'),
