...
from .models import ExpenseTypes as Table


urlpatterns = [
    url(r'^$', TemplateView.as_view(template_name="expensetypes/list.html"), name="index"),
    ...
    url(r'^add/$', TemplateView.as_view(template_name="expensetypes/form.html"), name='add'),
