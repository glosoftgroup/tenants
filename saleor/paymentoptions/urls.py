...
from .models import PaymentOptions as Table


urlpatterns = [
    url(r'^$', TemplateView.as_view(template_name="paymentoptions/list.html"), name="index"),
    ...
    url(r'^add/$', TemplateView.as_view(template_name="paymentoptions/form.html"), name='add'),
