...
function deleteThis(){
    parentList.confirmDelete();
}
var deleteInstance = new Vue({
    el:"#modal_instance",
    delimiters: ['${', '}'],
    data:{},
    methods: {
        confirmDelete(e){
            console.log('sdfhheee s sdfsdfsdfsdfsdff s f');
            e.preventDefault();
            console.log(parentList.deleteUrl);
        },
    },
    mounted:function(){
...
$('.daterange-single').daterangepicker({
        ...
        parentList.date = chosen_date.format('YYYY-MM-DD');
