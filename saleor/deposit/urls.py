...
from .models import Deposit as Table


urlpatterns = [
    url(r'^$', TemplateView.as_view(template_name="deposit/list.html"), name="index"),
    ...
    url(r'^add/$', TemplateView.as_view(template_name="deposit/form.html"), name='add'),
